...
`,
	...
	"Trapped Edge (Bad EO)": `
FF, R' D' F' D R, CROSS | F2LFR | F2LBL | F2LBR
FB, F D R D' F', CROSS | F2LFR | F2LBL | F2LFL
BF, F' (R' U' R) F, CROSS | F2LBR | F2LBL | F2LFL
BL-FR, L F' U F L', CROSS | F2LBL | F2LFL | F2LBR
BR-FL, (L' u' L) U' (L' u L), CROSS | F2LFL | F2LBL | F2LFR
`,
