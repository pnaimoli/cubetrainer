...
const WelcomeView: React.FC = () => (
  <Stack align="center" justify="center" style={{ height: '100%' }} maw={600} mx="auto">
    ...
    <List size="sm" spacing={4}>
      <List.Item><b>Optimal Cross</b> - random scrambles with optimal cross solutions shown. Filter by move count, train on any face, add random preorientation. Differential scrambles with a connected cube.</List.Item>
      <List.Item><b>XCross</b> - same idea but for xcross. Filter by slot, move count, and min extra moves over cross optimal.</List.Item>
      <List.Item><b>FR+FL Slot Game</b> - drill inserting the two front F2L pairs from random positions. Tracks optimal vs your move count.</List.Item>
